...
public class FactureController {
    ...
    @Operation(summary = "Récupérer toutes les factures with pagination")
    public Flux<FactureResponse> getAllFacturesPaginated(Pageable pageable) {
        log.info("Requête de récupération de toutes les factures avec pagination");
        return factureService.getAllFactures(pageable);
    }
