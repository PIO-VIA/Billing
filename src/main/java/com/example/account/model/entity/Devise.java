...
@Table(
    name = "devises",
    indexes = {
        @Index(name = "idx_devise_org", columnList = "organization_id"),
        @Index(name = "idx_devise_org_codedevise", columnList = "organization_id, code_devise")
    }
)
public class Devise extends OrganizationScoped {
